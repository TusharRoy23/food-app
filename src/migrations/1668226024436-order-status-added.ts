...
export class orderStatusAdded1668226024436 implements MigrationInterface {
    name = 'orderStatusAdded1668226024436'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."order_order_status_enum" RENAME TO "order_order_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."order_order_status_enum" AS ENUM('pending', 'released', 'paid', 'cancelled', 'in progress')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."order_order_status_enum_old" AS ENUM('pending', 'paid', 'cancelled', 'in progress')`);
        await queryRunner.query(`ALTER TABLE "order" ALTER COLUMN "order_status" DROP DEFAULT`);
